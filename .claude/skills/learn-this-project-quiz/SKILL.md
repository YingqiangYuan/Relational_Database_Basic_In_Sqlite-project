...
- State explicitly that you're in open-ended mode; suggest the user run `/learn-this-project-meta refresh quiz` later if any of the generated items are worth promoting to the persistent bank.
