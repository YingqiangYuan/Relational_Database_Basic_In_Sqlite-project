...
- When the user is ready to ship a clean public copy: "Switch to `/learn-this-project-publish` to remove teaching artifacts and co-write a personal README."
